...
public class Imaple extends Spider {
    ...
    public String homeContent(boolean filter) {
        try {
            ...
            try {
                // 取首页推荐视频列表
                Elements list = doc.select("li.col-lg-6>div");
    ...
    public String detailContent(List<String> ids) {
        try {
            ...
            Elements span_text_muted = doc.select("div.myui-content__detail>p>span.text-muted");
