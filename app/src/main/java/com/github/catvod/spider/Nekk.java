...
public class Nekk extends Spider {
    ...
    private static final String siteUrl = "https://www.9eguoyu.com";
    private static final String siteHost = "www.9eguoyu.com";
                ...
                if (scContent.startsWith("var player_")) {
                    ...
                    if (playerConfig.has(player.getString("from"))) {
                        ...
                        result.put("url", videoUrl);
                         if (flag.equals("9ekk") || flag.equals("gsyun") || flag.equals("9evvvip") || flag.equals("9evvip")) {
