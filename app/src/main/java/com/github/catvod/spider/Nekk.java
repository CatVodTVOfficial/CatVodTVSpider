...
public class Nekk extends Spider {
    ...
    private static final String siteUrl = "https://www.9e03.com";
    private static final String siteHost = "www.9e03.com";
            ...
            for (int i = 0; i < allScript.size(); i++) {
                ...
                if (scContent.startsWith("var player_")) {
                    ...
                    if (playerConfig.has(player.getString("from"))) {
                        ...
                        if (flag.equals("9ekk") || flag.equals("gsyun")) {
